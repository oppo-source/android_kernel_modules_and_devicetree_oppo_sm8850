...
import glob
import common
from ack_revison_check import check_ack_commit_exist
...
def main():
    ...
    if args.transfer == "upload":
        ...
        kernel_version, image_valid = check_image_is_valid(args, bootimg, unpack, kernel)
