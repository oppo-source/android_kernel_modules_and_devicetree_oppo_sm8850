	...
	int64_t clk_rate, int clk_idx, int32_t *clk_lvl)
{
	...
	CAM_INFO(CAM_ISP, "cam_soc_util_get_clk_level enter clk_idx %d clk_lvl %d", clk_idx, *clk_lvl);
    ...
    CAM_INFO(CAM_ISP, "clk round rate clk_idx %d clk_lvl %d", clk_idx, *clk_lvl);
