	...
	struct cam_isp_resource_node    *res)
{
	...
	if (res->res_id == CAM_IFE_PIX_PATH_RES_RDI_1)
		return true;
	...
	struct cam_ife_csid_ver2_hw *csid_hw)
{
    ...
    CAM_INFO(CAM_ISP, "CSID[%d] Reading the dual_csid_cfg from reg", hw_idx);
	...
	CAM_INFO(CAM_ISP, "CSID[%d] Dumping CSID Clock done", hw_idx);
