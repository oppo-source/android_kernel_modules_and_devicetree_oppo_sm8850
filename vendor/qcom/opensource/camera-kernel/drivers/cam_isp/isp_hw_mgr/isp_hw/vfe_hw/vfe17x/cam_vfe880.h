...
static struct cam_vfe_bus_ver3_err_irq_desc vfe880_bus_irq_err_desc[][32] = {
	{
		{
			.bitmask = BIT(26),
...
static struct  cam_vfe_bus_ver3_vfe_out_hw_info  vfe880_out_hw_hw_info[] = {
	{
	...
	},
	{
		...
		.pid_mask = BIT_ULL(24) | BIT_ULL(25) | BIT_ULL(26),
	},
	{
	...
	},
	{
		...
		.pid_mask = BIT_ULL(20) | BIT_ULL(21) | BIT_ULL(22),
	},
	{
...
static struct cam_vfe_bus_ver3_hw_info vfe880_bus_hw_info = {
	.common_reg = {
		...
		.num_perf_counters                = 8,
		.perf_cnt_status                  = 0x00000CB4,
		.perf_cnt_reg = {
			{
				.perf_cnt_cfg = 0x00000C74,
				.perf_cnt_val = 0x00000C94,
			},
			{
				.perf_cnt_cfg = 0x00000C78,
				.perf_cnt_val = 0x00000C98,
			},
			{
				.perf_cnt_cfg = 0x00000C7C,
				.perf_cnt_val = 0x00000C9C,
			},
			{
				.perf_cnt_cfg = 0x00000C80,
				.perf_cnt_val = 0x00000CA0,
			},
			{
				.perf_cnt_cfg = 0x00000C84,
				.perf_cnt_val = 0x00000CA4,
			},
			{
				.perf_cnt_cfg = 0x00000C88,
				.perf_cnt_val = 0x00000CA8,
			},
			{
				.perf_cnt_cfg = 0x00000C8C,
				.perf_cnt_val = 0x00000CAC,
			},
			{
				.perf_cnt_cfg = 0x00000C90,
				.perf_cnt_val = 0x00000CB0,
			},
		},
	},
	...
	.vfe_out_hw_info = vfe880_out_hw_hw_info,
	.num_out = ARRAY_SIZE(vfe880_out_hw_hw_info),
	.num_cons_err = 29,
