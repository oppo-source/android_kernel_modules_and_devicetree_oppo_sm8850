...
static struct  cam_vfe_bus_ver3_vfe_out_hw_info  tfe970_out_hw_hw_info[] = {
	{
		...
		.pid_mask      = BIT_ULL(9) | BIT_ULL(10) | BIT_ULL(8),
	},
	{
...
static struct cam_vfe_bus_ver3_hw_info tfe970_bus_hw_info = {
	...
	.bus_client_reg = {
		/* BUS Client 0 FULL */
		{
			...
			.ubwc_regs                = &tfe970_ubwc_regs_client_0,
		...
		/* BUS Client 5 DS2_Y */
		{
			...
			.comp_group               = CAM_VFE_BUS_VER3_COMP_GRP_0,
			.ubwc_regs                = &tfe970_ubwc_regs_client_5,
		...
		/* BUS Client 6 DS2_C */
		{
			...
			.comp_group               = CAM_VFE_BUS_VER3_COMP_GRP_0,
			.ubwc_regs                = &tfe970_ubwc_regs_client_6,
			.supported_formats        = BIT_ULL(CAM_FORMAT_PLAIN8) |
				BIT_ULL(CAM_FORMAT_PLAIN16_8) | BIT_ULL(CAM_FORMAT_PLAIN16_10) |
				BIT_ULL(CAM_FORMAT_PLAIN16_12) | BIT_ULL(CAM_FORMAT_PLAIN16_14) |
				BIT_ULL(CAM_FORMAT_PLAIN16_16) |
	...
	.vfe_out_hw_info = tfe970_out_hw_hw_info,
	.num_out = ARRAY_SIZE(tfe970_out_hw_hw_info),
	.num_cons_err = 32,
