...
static struct cam_vfe_top_ver4_diag_reg_info vfe_lite88x_diag_reg_info[] = {
	{
		.bitmask = 0x3FFF,
		.name    = "SENSOR_HBI",
	},
...
static struct cam_vfe_top_ver4_diag_reg_fields vfe_lite88x_diag_sensor_field[] = {
	{
		.num_fields = 3,
		.field      = &vfe_lite88x_diag_reg_info[0],
	},
	{
		.num_fields = 1,
		.field      = &vfe_lite88x_diag_reg_info[3],
	},
};

static struct cam_vfe_top_ver4_diag_reg_fields vfe_lite88x_diag_frame_field[] = {
	{
		.num_fields = 4,
		.field      = &vfe_lite88x_diag_reg_info[4],
	},
	{
		.num_fields = 1,
		.field      = &vfe_lite88x_diag_reg_info[8],
	},
};
...
static struct cam_vfe_top_ver4_hw_info vfe_lite88x_top_hw_info = {
	...
	.diag_sensor_info = vfe_lite88x_diag_sensor_field,
	.diag_frame_info  = vfe_lite88x_diag_frame_field,
};
...
static struct  cam_vfe_bus_ver3_vfe_out_hw_info vfe88x_out_hw_hw_info[] = {
	{
		...
		.pid_mask = BIT_ULL(27) | BIT_ULL(28),
	},
	{
...
static struct cam_vfe_bus_ver3_hw_info vfe_lite88x_bus_hw_info = {
	...
	.num_out = ARRAY_SIZE(vfe88x_out_hw_hw_info),
	.vfe_out_hw_info = vfe88x_out_hw_hw_info,
	.num_comp_grp    = 5,
