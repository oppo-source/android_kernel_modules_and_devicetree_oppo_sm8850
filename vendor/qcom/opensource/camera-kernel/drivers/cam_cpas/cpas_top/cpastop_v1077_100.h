...
static struct cam_camnoc_irq_sbm cam_cpas_v1077_100_irq_sbm_rt = {
	.sbm_enable = {
		...
		.value = 0x01 |   /* RT_SBM_FAULTINEN0_LOW_PORT0_MASK - Slave error IRQ */
			0x02 |   /* RT_SBM_FAULTINEN0_LOW_PORT1_MASK - TFE UBWC-0 Encoder Error IRQ */
			0x04,   /* RT_SBM_FAULTINEN0_LOW_PORT2_MASK - TFE UBWC-1 Encoder Error IRQ */
	},
	.sbm_status = {
...
static struct cam_camnoc_irq_sbm cam_cpas_v1077_100_irq_sbm_nrt = {
	.sbm_enable = {
		...
		.value = 0x01 |   /* NRT_SBM_FAULTINEN0_LOW_PORT0_MASK - Slave Error */
			...
			0x40,     /* NRT_SBM_FAULTINEN0_LOW_PORT6_MASK - AHB Bus Timeout En */
	},
	.sbm_status = {
		.access_type = CAM_REG_TYPE_READ,
		.enable = true,
...
static struct cam_camnoc_irq_err
	...
	},
	{
		...
		.err_enable = {
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.enable = true,
			.offset = 0x2DA0, /* TFE_UBWC : RT_0_NIU_ENCERREN_LOW */
			.value = 0xF,
		},
		.err_status = {
			.access_type = CAM_REG_TYPE_READ,
			.enable = true,
			.offset = 0x2D90, /* IFE_UBWC : RT_0_NIU_ENCERRSTATUS_LOW */
		},
		.err_clear = {
			.access_type = CAM_REG_TYPE_WRITE,
			.enable = true,
			.offset = 0x2D98, /* IFE_UBWC : RT_0_NIU_ENCERRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		.irq_type = CAM_CAMNOC_HW_IRQ_TFE_UBWC_1_ENCODE_ERROR,
		.enable = true,
		.sbm_port = 0x04, /* RT_SBM_FAULTINSTATUS0_LOW_PORT2_MASK */
		.err_enable = {
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.enable = true,
			.offset = 0x2FA0, /* TFE_UBWC : RT_1_NIU_ENCERREN_LOW */
			.value = 0xF,
		},
		.err_status = {
			.access_type = CAM_REG_TYPE_READ,
			.enable = true,
			.offset = 0x2F90, /* IFE_UBWC : RT_1_NIU_ENCERRSTATUS_LOW */
		},
		.err_clear = {
			.access_type = CAM_REG_TYPE_WRITE,
			.enable = true,
			.offset = 0x2F98, /* IFE_UBWC : RT_1_NIU_ENCERRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.enable = false,
		.sbm_port = 0x8, /* RT_SBM_FAULTINSTATUS0_LOW_PORT5_MASK */
		.err_enable = {
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.enable = true,
...
static struct cam_camnoc_irq_err
	...
	},
	{
		.irq_type = CAM_CAMNOC_HW_IRQ_CAMNOC_TEST,
		.enable = false,
		.sbm_port = 0x80, /* NRT_SBM_FAULTINSTATUS0_LOW_PORT10_MASK */
		.err_enable = {
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.enable = true,
			.offset = 0x288, /* CAM_NOC_NRT_SBM_FLAGOUTSET0_LOW */
...
static struct cam_camnoc_niu
	...
	/* RT ports */
	{
		...
		.priority_lut_low = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2C30, /* NOC_RT_0_NIU_PRIORITYLUT_LOW */
			.value = 0x66655554,
		},
		.priority_lut_high = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2C34, /* NOC_RT_0_NIU_PRIORITYLUT_HIGH */
			.value = 0x66666666,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2C38, /* NOC_RT_0_NIU_URGENCY_LOW */
			.value = 0x00001E40,
		},
		.danger_lut = {
			.enable = true,
		...
		.safe_lut = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2C48, /* NOC_RT_0_NIU_SAFELUT_LOW */
			.value = 0x0000000F,
		},
		.ubwc_ctl = {
			/*
		...
		.dynattr_mainctl = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3608, /* NOC_RT_0_DYNATTR_MAINCTL */
			.value = 0x0,
		},
		.qosgen_mainctl = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2808, /* NOC_RT_0_QOSGEN_MAINCTL */
			.value = 0x0,
		},
		.qosgen_shaping_low = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2820, /* NOC_RT_0_QOSGEN_SHAPING_LOW */
			.value = 0x0,
		},
		.qosgen_shaping_high = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2824, /* NOC_RT_0_QOSGEN_SHAPING_HIGH */
			.value = 0x0,
		},
		.maxwr_low = {
			.enable = true,
	...
	},
	{
		...
		.priority_lut_low = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2E30, /* NOC_RT_1_NIU_PRIORITYLUT_LOW */
			.value = 0x55544444,
		},
		.priority_lut_high = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2E34, /* NOC_RT_1_NIU_PRIORITYLUT_HIGH */
			.value = 0x66666665,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2E38, /* NOC_RT_1_NIU_URGENCY_LOW */
			.value = 0x00001C40,
		},
		.danger_lut = {
			.enable = true,
		...
		.safe_lut = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2E48, /* NOC_RT_1_NIU_SAFELUT_LOW */
			.value = 0x0000000F,
		},
		.ubwc_ctl = {
			/*
		...
		.dynattr_mainctl = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3688, /* NOC_RT_1_DYNATTR_MAINCTL */
			.value = 0x0,
		},
		.qosgen_mainctl = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2888, /* NOC_RT_1_QOSGEN_MAINCTL */
			.value = 0x0,
		},
		.qosgen_shaping_low = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x28A0, /* NOC_RT_1_QOSGEN_SHAPING_LOW */
			.value = 0x0,
		},
		.qosgen_shaping_high = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x28A4, /* NOC_RT_1_QOSGEN_SHAPING_HIGH */
			.value = 0x0,
		},
		.maxwr_low = {
			.enable = true,
	...
	},
	{
		...
		.priority_lut_low = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3030, /* NOC_RT_2_NIU_PRIORITYLUT_LOW */
			.value = 0x44444444,
		},
		.priority_lut_high = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3034, /* NOC_RT_2_NIU_PRIORITYLUT_HIGH */
			.value = 0x66666644,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3038, /* NOC_RT_2_NIU_URGENCY_LOW */
			.value = 0x00001C40,
		},
		.danger_lut = {
			.enable = true,
		...
		.safe_lut = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3048, /* NOC_RT_2_NIU_SAFELUT_LOW */
			.value = 0x0000000F,
		},
		.ubwc_ctl = {
			/*
		...
		.dynattr_mainctl = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3708, /* NOC_RT_2_DYNATTR_MAINCTL */
			.value = 0x0,
		},
		.qosgen_mainctl = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2908, /* NOC_RT_2_QOSGEN_MAINCTL */
			.value = 0x0,
		},
		.qosgen_shaping_low = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2920, /* NOC_RT_2_QOSGEN_SHAPING_LOW */
			.value = 0x0,
		},
		.qosgen_shaping_high = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2924, /* NOC_RT_2_QOSGEN_SHAPING_HIGH */
			.value = 0x0,
		},
		.maxwr_low = {
			.enable = true,
	...
	{
		.port_name = "RT3-RT_CDM",
		.enable = true,
		.priority_lut_low = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3230, /* NOC_RT_3_NIU_PRIORITYLUT_LOW */
			.value = 0x33333333,
		},
		.priority_lut_high = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3234, /* NOC_RT_3_NIU_PRIORITYLUT_HIGH */
			.value = 0x33333333,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3238, /* NOC_RT_3_NIU_URGENCY_LOW */
			.value = 0x3,
		},
		.danger_lut = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3240, /* NOC_RT_3_NIU_DANGERLUT_LOW */
			.value = 0x0,
		},
		.safe_lut = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3248, /* NOC_RT_3_NIU_SAFELUT_LOW */
			.value = 0xF,
		},
		.ubwc_ctl = {
			/*
		...
		.dynattr_mainctl = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x3788, /* NOC_RT_3_DYNATTR_MAINCTL */
			.value = 0x0,
		},
		.qosgen_mainctl = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x2988, /* NOC_RT_3_QOSGEN_MAINCTL */
			.value = 0x0,
		},
		.qosgen_shaping_low = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x29A0, /* NOC_RT_3_QOSGEN_SHAPING_LOW */
			.value = 0x0,
		},
		.qosgen_shaping_high = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x29A4, /* NOC_RT_3_QOSGEN_SHAPING_HIGH */
			.value = 0x0,
		},
	},
};
...
static struct cam_camnoc_niu
	...
	{
		.port_name = "NRT6-JPEG0,1,2,3_RD_WR_ENC_RD_WR",
		.enable = true,
		.priority_lut_low = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
...
static struct cam_cpas_hw_info cam1077_cpas100_hw_info = {
	.hw_info_version                = CAM_CPAS_HW_INFO_VER1,
	.camnoc_info[CAM_CAMNOC_HW_RT]  = &cam1077_cpas100_camnoc_info_rt,
	.camnoc_info[CAM_CAMNOC_HW_NRT] = &cam1077_cpas100_camnoc_info_nrt,
