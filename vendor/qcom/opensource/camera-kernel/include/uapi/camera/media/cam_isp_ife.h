...
#define CAM_ISP_IFE_OUT_RES_FD2                  (CAM_ISP_IFE_OUT_RES_BASE + 43)
#define CAM_ISP_IFE_OUT_PDAF_PREPROCESSED2       (CAM_ISP_IFE_OUT_RES_BASE + 44)
#define CAM_ISP_IFE_OUT_RES_IDEAL_RAW            (CAM_ISP_IFE_OUT_RES_BASE + 45)
