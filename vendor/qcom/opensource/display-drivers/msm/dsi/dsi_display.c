				...
				u32 curr_refresh_rate, int i)
{
	...
	DSI_INFO("dfps_type=%d, cur_fps=%d, adj_fps=%d, h_active=%d, v_active=%d, hfp:%d, hbp:%d, hpw:%d, vbp:%d, vfp:%d, vpw:%d",
