...
extern bool iris_need_short_read_workaround(void);

enum IRIS_PLATFORM {
	IRIS_FPGA = 0,
	IRIS_ASIC,
};
extern int iris_platform_get(void);
extern void iris_fpga_adjust_read_buf(u32 repeated_bytes,
							   u32 read_offset,
							   u32 rx_byte,
							   u32 read_cnt,
							   u8 *rd_buf);
extern void iris_fpga_adjust_read_cnt(u32 read_offset,
							   u32 rx_byte,
							   u32 read_cnt,
							   int *pcnt);
