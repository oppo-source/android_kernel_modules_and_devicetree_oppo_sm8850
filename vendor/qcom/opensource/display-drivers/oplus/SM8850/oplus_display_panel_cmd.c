...
const char *cmd_set_prop_map[DSI_CMD_SET_MAX] = {
	...
	"oplus,dsi-panel-gamma-compensation-page3-command",
	...
	"qcom,mdss-dsi-fps-switch-165-to-120-command",
	"qcom,mdss-dsi-fps-switch-165-to-60-command",
	"qcom,mdss-dsi-fps-switch-165-to-90-command",
	"qcom,mdss-dsi-fps-switch-165-to-144-command",
	"qcom,mdss-dsi-fps-switch-60-to-165-command",
	"qcom,mdss-dsi-fps-switch-90-to-165-command",
	"qcom,mdss-dsi-fps-switch-120-to-165-command",
	"qcom,mdss-dsi-fps-switch-144-to-165-command",
...
const char *cmd_set_state_map[DSI_CMD_SET_MAX] = {
	...
	"oplus,dsi-panel-gamma-compensation-page3-command-state",
	...
	"qcom,mdss-dsi-fps-switch-165-to-120-command-state",
	"qcom,mdss-dsi-fps-switch-165-to-60-command-state",
	"qcom,mdss-dsi-fps-switch-165-to-90-command-state",
	"qcom,mdss-dsi-fps-switch-165-to-144-command-state",
	"qcom,mdss-dsi-fps-switch-60-to-165-command-state",
	"qcom,mdss-dsi-fps-switch-90-to-165-command-state",
	"qcom,mdss-dsi-fps-switch-120-to-165-command-state",
	"qcom,mdss-dsi-fps-switch-144-to-165-command-state",
