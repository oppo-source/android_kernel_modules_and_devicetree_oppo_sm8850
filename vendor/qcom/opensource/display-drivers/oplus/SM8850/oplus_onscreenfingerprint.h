...
static struct lhbm_fpr_ratio_entry lhbm_fpr_ratio[] = {
	{0, 1688, 11021, 11490, 11507},
    {1689, 1742, 11000, 11462, 11483},
...
/* log level config */
extern unsigned int oplus_ofp_log_now_level;
/* dual display id */
