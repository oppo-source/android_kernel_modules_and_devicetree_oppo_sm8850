...
static int ktz8869_ic_write_byte_single(struct i2c_client *i2c_client, unsigned char addr, unsigned char value)
{
	int ret = 0;
   ...
   pr_err("ktz8869_ic_write_byte_single write addr = 0x%x, value = 0x%x\n", addr, value);
...
static int ktz8869_ic_write_byte_dual(unsigned char addr, unsigned char value)
{
	...
	pr_err("ktz8869_ic_write_byte_dual write addr = 0x%x, value = 0x%x\n", addr, value);

	return ret;
}

int ktz8869_ic_read_byte_dual(struct i2c_client *i2c_client_m, unsigned char i2c_client_m_addr, unsigned char *i2c_client_m_buf,
