    ...
    config_srcs = {
        ...
        "CONFIG_MSM_SDE_ROTATOR": {
         ...
         "OPLUS_FEATURE_TP_BASIC" : [
             "oplus/SM8850/oplus_display_notify_tp.c",
         ],
      ...
      config_deps = {
        ...
        "CONFIG_OPLUS_TYPEC_SWITCH_I2C": [
            "//vendor/qcom/opensource/audio-kernel:%b_oplus_typec_switch_i2c",
            "//vendor/qcom/opensource/audio-kernel:oplus_typec_switch_headers",
        ],
