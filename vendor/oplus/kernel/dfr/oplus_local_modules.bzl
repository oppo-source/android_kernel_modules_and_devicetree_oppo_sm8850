...
#        ],
    ...
    define_oplus_ddk_module(
        name = "oplus_bsp_dfr_escape_mode",
        srcs = native.glob([
            "**/*.h",
            "common/oplus_escape/oplus_escape.c",
        ]),
        includes = ["."],
    )
    ...
    define_oplus_ddk_module(
        name = "oplus_inject_aw8693xs",
        srcs = native.glob([
            "**/*.h",
        ]),
        conditional_srcs = {
            "CONFIG_OPLUS_DDK_MTK": {
                True:  ["fault_inject/vibrator/oplus_inject_aw8693xs.c"],
                False: ["fault_inject/vibrator/oplus_inject_haptics.c"],
            },
        },
        ko_deps = [
    ...
    define_oplus_ddk_module(
        ...
        local_defines = [
            "CONFIG_OPLUS_FEATURE_FULLDUMP_BACK",
            "OPLUS_FEATURE_FULLDUMP_BACK_SHRINK"
        ],
    )
