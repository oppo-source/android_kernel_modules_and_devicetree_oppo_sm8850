...
static void android_vh_binder_check_special_work_handler(void *unused,
...
void register_binder_sched_vendor_hooks(void)
{
	...
	register_trace_android_vh_binder_check_special_work(
		android_vh_binder_check_special_work_handler, NULL);
