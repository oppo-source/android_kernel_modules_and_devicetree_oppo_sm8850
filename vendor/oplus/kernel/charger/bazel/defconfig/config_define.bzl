...
load(":defconfig/unisoc/oplus_ums9360_user_config.bzl", "oplus_ums9360_user_config")
load(":defconfig/unisoc/oplus_ums9360_userdebug_config.bzl", "oplus_ums9360_userdebug_config")
...
oplus_config = {
    ...
    "unisoc": {
        "ums9360": {
            "user": oplus_ums9360_user_config,
            "userdebug": oplus_ums9360_user_config | oplus_ums9360_userdebug_config
        },
    }
}
