...
enum {
	...
	VOOCPHY_BATT_TEMP_NORMAL,		/* 20 ~ 25 */
	VOOCPHY_BATT_TEMP_NORMAL_MID,		/* 25 ~ 35 */
...
enum {
	...
	BATT_SYS_CURVE_TEMP_NORMAL_MID,
...
struct oplus_voocphy_manager {
	...
	int vooc_normal_mid_temp_default;
