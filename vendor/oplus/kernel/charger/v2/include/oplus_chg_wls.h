...
#define WLS_RX_PROTOCOL_VERSION_31	0x1f
...
#define WLS_CMD_ASK_TX_CAP_CHANGE	0xA2
...
#define WLS_CMD_GET_UFCSTA_FWDATE	0xA7
...
#define WLS_CMD_TX_RESPONE_TA_CAPCHANGE	0xF2
...
#define WLS_TX_ERROR_Q_FOD		0x0A
#define WLS_TX_ERROR_F_FOD		0x0B
...
#define WLS_UFCSTA_FW_YEAR_OFFSET	0x4
#define WLS_UFCSTA_FW_YEAR_MASK		0xf0
#define WLS_UFCSTA_FW_MONTH_MASK	0x0f
...
#define WLS_RESPONE_UFCSTA_FWDATE	0xF7
...
#define WLS_ADAPTER_EPP_HW_ID_MASK 	0xF8
#define WLS_ADAPTER_EPP_DOCK_TYPE	0x07
...
#define WLS_PRODUCT_ID_ERROR_MAX_POWER_W	20

#define WLS_MAX_STEP_CHG_ENTRIES	9
#define WLS_FOD_PARM_LEN_MAX		64
#define BCC_MAX_STEP_ENTRIES		9
...
#define WLS_ADAPTER_THIRD_PARTY_V31_MAG		0x1D
#define WLS_ADAPTER_THIRD_PARTY_V31_NO_MAG	0x1E
#define WLS_ADAPTER_THIRD_PARTY			0x1F
#define WLS_ADAPTER_MODEL_MAX			16

#define WLS_EPP_TX_MANU_ID_UNKNOWN		0x0000
#define WLS_EPP_OPLUS_TX_MANU_ID		0x00D7
#define WLS_EPP_ONEPLUS_TX_MANU_ID		0x00CD

#define IS_WLS_THIRD_PARTY(adapter_id) \
	(((adapter_id) == (WLS_ADAPTER_THIRD_PARTY_V31_MAG)) || \
	((adapter_id) == (WLS_ADAPTER_THIRD_PARTY_V31_NO_MAG)) || \
	((adapter_id) == (WLS_ADAPTER_THIRD_PARTY)))

#define IS_WLS_THIRD_PARTY_GE_V31(adapter_id) \
	(((adapter_id) == (WLS_ADAPTER_THIRD_PARTY_V31_MAG)) || \
	((adapter_id) == (WLS_ADAPTER_THIRD_PARTY_V31_NO_MAG)))

#define IS_WLS_OPLUS_TX_MANU_ID(tx_manu_id) \
	(((tx_manu_id) == (WLS_EPP_TX_MANU_ID_UNKNOWN)) || \
	((tx_manu_id) == (WLS_EPP_OPLUS_TX_MANU_ID)) || \
	((tx_manu_id) == (WLS_EPP_ONEPLUS_TX_MANU_ID)))

#define IS_WLS_EPP_RX_MODE(rx_mode) \
...
#define WLS_UFCS_ADAPTER_AP_POWER	50000
#define WLS_UFCS_ADAPTER_XBA_AP_POWER	40000
#define WLS_UFCS_ADAPTER_XBA_POWER_W	80
#define WLS_UFCS_ADAPTER_XBA_MANU_YEAR	2022
#define WLS_UFCS_ADAPTER_XBA_MANU_MONTH	2
...
#define WLS_TX_TA_CAP_CHANGE_STEP_MA			500
#define WLS_TX_TA_CAP_CHANGE_LIMIT_LOW_MA		1000
...
#define OPLUS_CHG_DEBUG_INFO_LEN 	512
