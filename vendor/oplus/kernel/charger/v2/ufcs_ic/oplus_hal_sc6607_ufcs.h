...
#define SC6607_UFCS_OPTION2	0x70
...
#define SC6607_SEND_ENABLE_HIZ		BIT(0)
#define SC6607_SEND_CLR_RX_BUF		BIT(4)
#define SC660_FLAG_CLR_RX_BUF_SHIFT	(4)
...
#define SC6607_FLAG_RX_BUFFER_BUSY		BIT(2)
