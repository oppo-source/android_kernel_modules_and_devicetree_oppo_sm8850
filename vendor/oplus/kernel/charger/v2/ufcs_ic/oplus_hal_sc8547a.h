...
#define SC8547A_SEND_ENABLE_HIZ BIT(0)
...
#define SC8547A_RX_BUFFER_BUSY_FLAG BIT(2)
...
#define SC8547A_SEAND_CLR_RX_BUF BIT(4)
#define SC8547A_FLAG_CLR_RX_BUF_SHIFT (4)
...
#define SC8547A_CP_SWITCHING_STAT_MASK	BIT(2)
