...
#define SC6607_BUCK_NAME		"sc6607-buck"
#define FOUND_BUCK_ADDR_MAX_COUNT	100
#define FOUND_BUCK_ADDR_MAX_DELAY	1000
...
struct sc6607 {
	...
	struct regmap *usb_dischg_regmap;
	u32 usb_dischg_reg;
	u32 usb_dischg_mask;
	u32 usb_dischg_on_val;
	u32 usb_dischg_off_val;
};
