...
load("//build/kernel/oplus:oplus_kunit_modules.bzl", "define_oplus_kunit_ddk_modules")
...
def define_oplus_local_modules():
    ...
    define_oplus_ddk_module(
        ...
        conditional_srcs = {
            "CONFIG_OPLUS_SYSTEM_KERNEL_QCOM": {
                True: ["oplus_projectinfo/qcom/oplus_project.c"]
            },
            "CONFIG_OPLUS_SYSTEM_KERNEL_MTK": {
    ...
    define_oplus_ddk_module(
        ...
        srcs = native.glob([
            ...
            "oplus_phoenix/phoenix_escape.c",
        ]),
    ...
    define_oplus_ddk_module(
        name = "oplus_kunit_example_test_module",
        srcs = native.glob(["boot_kunit/kunit_test.c"]),
        includes = ["include"],
    )
    ...
    define_oplus_kunit_ddk_modules(
        name = "oplus_bsp_boot_kunit",
        module_list = [
            "oplus_kunit_example_test_module",
        ],
    )
