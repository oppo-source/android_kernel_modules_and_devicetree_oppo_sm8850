...
#define RT_VTIME	(p->prio)
#define UX_VTIME	(MAX_RT_PRIO)
#define VIP_MVP_VTIME	(MAX_RT_PRIO + 1)
#define PCP_CFS_VTIME	(MAX_RT_PRIO + 2)
#define HIGH_CFS_VTIME	(MAX_RT_PRIO + 3)
#define NORM_CFS_VTIME	(MAX_RT_PRIO + 4)
#define LOW_CFS_VTIME	(MAX_RT_PRIO + 5)
#define SCX_SWITCH_MAX_REPEAT 2
