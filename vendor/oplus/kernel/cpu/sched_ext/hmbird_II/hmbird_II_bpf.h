...
#define HMBIRD_SCHED_PROP_PREFER_PRI_SHIFT      (50)
#define HMBIRD_SCHED_PROP_PREFER_PRI_MASK       (0x3UL << HMBIRD_SCHED_PROP_PREFER_PRI_SHIFT)
#define HMBIRD_SCHED_PROP_PREFER_PRI1           BIT(50)
#define HMBIRD_SCHED_PROP_PREFER_PRI0           BIT(51)
...
/* hmbird feature list */
#define HMBIRD_FEATURE_MULTI_PREEMPT        (1UL << 0)
