...
bool is_current_type(u64 nr, unsigned long nowtype)
{
	bool ret = false;
...
#ifdef JANK_DEBUG
void dump_callstacks(struct task_struct *task, u64 *cs, u64 delta)
{
	s32 i;
...
static void record_target_latency(struct task_struct *p, u64 type, u64 delta)
{
	struct sched_record_struct *cur;
	static s32 latency_counter;
...
static void record_target_iowait(struct task_struct *p, u64 type, u64 delta)
{
	struct sched_record_struct *cur;
	static s32 iowait_counter;
	struct timespec64 ts;
...
s32 tasktrack_register_hook(void)
{
	s32 ret = 0;
...
s32 tasktrack_unregister_hook(void)
{
	s32 ret = 0;
...
static s32 proc_task_track_read(struct seq_file *m, void *v)
{
	u32 task_count;
...
static s32 proc_task_track_open(struct inode *inode,
			struct file *file)
{
	return single_open(file, proc_task_track_read, inode);
}

static s32 proc_task_track_enable_read(struct seq_file *m, void *v)
{
	seq_printf(m, "%d\n", tasktrack_enable);
	return 0;
}
...
static s32 proc_task_track_enable_open(struct inode *inode,
		struct file *file)
{
	return single_open(file, proc_task_track_enable_read, inode);
}

static s32 dump_callstack(struct seq_file *m, void *v)
{
	u32 task_count;
	u32 i, j, winidx, idx;
	pid_t pid;
...
static s32 proc_sched_latency_show(struct seq_file *m, void *v)
{
	struct sched_record_struct *cur;
	s32 i;
...
static s32 proc_sched_iowait_show(struct seq_file *m, void *v)
{
	struct sched_record_struct *cur;
	s32 i;
...
static s32 proc_callstack_show(struct seq_file *m, void *v)
{
	return dump_callstack(m, v);
}

static s32 proc_callstack_open(struct inode *inode,
		struct file *file)
{
	return single_open(file, proc_callstack_show, inode);
}

static s32 proc_sched_latency_open(struct inode *inode,
	struct file *file)
{
	return single_open(file, proc_sched_latency_show, inode);
}

static s32 proc_sched_iowait_open(struct inode *inode,
		struct file *file)
{
