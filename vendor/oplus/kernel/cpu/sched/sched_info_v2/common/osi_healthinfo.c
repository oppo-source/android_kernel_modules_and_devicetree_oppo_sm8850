...
/*Default init 0x5a02301f 1510092831
 * OHM_LIST_MAGIC | OHM_CTRL_CPU_CUR | OHM_CTRL_MEMMON |  OHM_CTRL_IONMON | OHM_CTRL_SCHEDTOTAL;
 * If you want to open this feature, please "echo ohmctrl1510092831 > /proc/oplus_healthinfo/para_update"
*/
static int ohm_ctrl_list = 0;
...
static ssize_t cpu_load_read(struct file *filp, char __user *buff, size_t count, loff_t *off)
{
	...
	load = cpuload_get_by_window(1, 0xFF);
	if (load < 0) {
		load = 0;
