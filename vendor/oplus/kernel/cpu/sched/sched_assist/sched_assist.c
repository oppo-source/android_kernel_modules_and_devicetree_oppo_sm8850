...
#ifndef CONFIG_OPLUS_SYSTEM_KERNEL_QCOM
	REGISTER_TRACE_RVH(android_rvh_check_preempt_wakeup_fair, android_rvh_check_preempt_wakeup_fair_handler);
...
#if 0
	/* mark disabled until the gki image contains the android_vh_reweight_entity newest hook*/
