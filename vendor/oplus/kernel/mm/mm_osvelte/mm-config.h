...
struct config_oplus_bsp_uxmem_opt {
	bool enable;
	unsigned int page_pool_order0_unmovable_mb;
	unsigned int page_pool_order0_movable_mb;
	unsigned int page_pool_order1_unmovable_mb;
	unsigned int page_pool_order1_movable_mb;
};
