...
def define_oplus_local_modules():
    ...
    if bazel_support_platform == "qcom" :
        ...
        hybridswap_zram_ko_deps = [
            "//kernel_device_modules-6.12/drivers/gpu/drm/mediatek/mediatek_v2:mtk_disp_notify",
            ":oplus_bsp_mm_osvelte",
            "//kernel_device_modules-6.12/drivers/dma-buf/heaps:oplus_boost_pool_mtk",
        ...
        if target in ["k6789v1_64", "k6895v1_64"] :
            ...
            zram_opt_ko_deps = [
                "//kernel_device_modules-6.12/drivers/misc/mediatek/mtk_zram:mtk_zram",
                "//vendor/oplus/kernel/cpu:oplus_bsp_sched_assist",
                ":oplus_bsp_mm_osvelte",
            ]
...
#
    define_oplus_ddk_module(
        ...
        srcs = native.glob([
            ...
            "hybridswap_zram/kcompressd/kcompressd.c",
...
#       }),
    ...
    define_oplus_ddk_module(
        name = "oplus_bsp_mm_misc",
        srcs = native.glob([
            "mm_misc/mm_misc.c",
        ]),
        includes = ["."],
        local_defines = ["CONFIG_ALLOC_SLOWPATH_STAT"],
    )
