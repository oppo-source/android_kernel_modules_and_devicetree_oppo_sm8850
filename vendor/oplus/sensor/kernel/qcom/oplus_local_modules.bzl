...
def define_oplus_local_modules():
    ...
    if bazel_support_target == "canoe" :
        ...
        oplus_trace_sensor_ko_deps = [
            "//vendor/oplus/sensor/kernel:oplus_trace_sensor_err",
        ]
        oplus_trace_sensor_err_header_deps = [
            "//vendor/oplus/sensor/kernel:oplus_trace_sensor_err_headers",
        ]
    else :
        oplus_bsp_boot_projectinfo_ko_deps = []
        oplus_bsp_kfb_ko_deps = []
    ...
    define_oplus_ddk_module(
        ...
        ko_deps = smem_ko_deps + oplus_bsp_kfb_ko_deps + oplus_trace_sensor_ko_deps,
    )
