...
EXPORT_SYMBOL_GPL(oplus_sensor_input_event);
...
EXPORT_SYMBOL_GPL(oplus_sensor_event_read);
...
EXPORT_SYMBOL_GPL(oplus_sensor_event_poll);
...
EXPORT_SYMBOL_GPL(oplus_sensor_event_register);
...
EXPORT_SYMBOL_GPL(oplus_sensor_event_deregister);
