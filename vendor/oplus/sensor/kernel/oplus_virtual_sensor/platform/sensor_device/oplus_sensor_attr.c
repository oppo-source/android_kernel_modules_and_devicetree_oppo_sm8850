...
EXPORT_SYMBOL_GPL(oplus_sensor_attr_register);
...
EXPORT_SYMBOL_GPL(oplus_sensor_attr_deregister);
...
#else
	oplus_sensor_attr_class = class_create("oplus_sensor");
#endif
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("sensor attribute driver");
